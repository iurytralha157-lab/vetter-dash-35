              ...
              try {
                const { error } = await supabase
                  ...
                  .update({
                    ...
                    utm_padrao: data.utm_padrao,
                    webhook_meta: data.webhook_meta,
                    ...
                    contrato_renovacao: data.contrato_renovacao,
